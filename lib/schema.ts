...
// Enum for node types
export const nodeTypeEnum = pgEnum('node_type', ['issue', 'action', 'resource', 'deliverable', 'gate', 'text-card', 'image-card', 'link-card', 'section', 'annotation', 'arrow', 'drawing']);
...
// Node type enum
export type NodeType = 'issue' | 'action' | 'resource' | 'deliverable' | 'gate' | 'text-card' | 'image-card' | 'link-card' | 'section' | 'annotation' | 'arrow' | 'drawing';
